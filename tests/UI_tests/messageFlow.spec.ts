...
test.describe('Support Messaging Flow', { tag: ['@regression', '@ui'] }, () => {
    test('Full warranty support thread: customer opens, admin replies, customer closes', async ({
        customerPageObjects,
        customerPage,
        adminPageObjects,
    }) => {
        ...
        await expect(customerPage.getByRole('alert')).toHaveText(
